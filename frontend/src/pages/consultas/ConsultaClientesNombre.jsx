// RUTA: src/pages/consultas/ConsultaClientesNombre.jsx
// -------------------------------------------------------------------
// Consulta de Clientes por Nombre — Página 34 del PDF
// -------------------------------------------------------------------
...
export default function ConsultaClientesNombre() {
  ...
  const buscar = () => {
    ...
    api
      .get(`/consultas/clientes_por_nombre/?nombre=${nombre}`)
